...
namespace acc_engineer::rpc::detail
{
    ...
    public:
        ...
        net::awaitable <detail::response_t<Message>>
        async_call(const detail::request_t<Message> &request, detail::duration_t timeout = detail::duration_t::max());
    ...
    template<detail::async_datagram MethodChannel>
    datagram_stub<MethodChannel>::datagram_stub(MethodChannel
    method_channel,
