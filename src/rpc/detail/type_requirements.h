...
namespace acc_engineer::rpc::detail
{
	...
	requires(Stream stream, net::mutable_buffer read_buffer,
	         net::const_buffer write_buffer)
	{
	...
	requires(Datagram datagram, typename Datagram::endpoint_type endpoint,
	         net::mutable_buffer read_buffer, net::const_buffer write_buffer)
	{
	...
	concept method_channel = async_stream<MethodChannel> || async_datagram<
		MethodChannel>;
	...
	requires(MethodImplement implement,
	         const typename MethodMessage::Request& request)
	{
