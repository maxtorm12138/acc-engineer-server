...
protected:
    [[nodiscard]] std::string pack(
        uint64_t command_id, std::bitset<64> bit_flags, const Cookie &cookie, const std::string &message_payload) const;
    ...
    net::awaitable<void> invoke_method(
