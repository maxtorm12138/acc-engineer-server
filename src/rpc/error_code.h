...
namespace acc_engineer::rpc
{
	...
	{
	public:
		const char* name() const noexcept final { return "logic error"; }
...
template <> struct boost::system::is_error_code_enum<acc_engineer::rpc::logic_error> : std::true_type
{
};

template <> struct boost::system::is_error_code_enum<acc_engineer::rpc::system_error> : std::true_type
{
};
