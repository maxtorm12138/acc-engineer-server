...
namespace acc_engineer::detail
{
    ...
    struct AddressType
    {
        AddressType(const std::string &address) : address(net::ip::make_address(address)) {}
...
namespace acc_engineer
{
    config config::from_command_line(int argc, char *argv[])
    {
        ...
        descriptions.add_options()
                            ...
                            ("password,P", po::value<std::string>()->required(), "authentication password");
